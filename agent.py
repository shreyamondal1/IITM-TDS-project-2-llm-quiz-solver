...
if not AIPIPE_API_KEY:
    raise ValueError("AIPIPE_API_KEY environment variable is not set. Please configure it in Hugging Face Space settings.")

# Set environment variable for OpenAI-compatible API
...
def agent_node(state: AgentState):
    ...
    # Use character-based approximation instead of token counter for non-OpenAI models
    ...
    trimmed_messages = trim_messages(
        ...
        include_system=True,
        start_on="human",
        token_counter=len,  # Use character count as approximation
    )
